<template>
  ...
  <div class="container">
    ...
    <div class="d-flex mb-5 row">
      ...
      <div class="text-center col-12 col-xl-3 my-xl-auto mt-5">
        ...
        <router-link
          to="/user/products"
          class="btn btn-outline-primary rounded-pill animation_hover fs-5"
  ...
  <div class="card_container">
    <div class="cake_container">
      <h3 class="badge fs-5 text-primary mb-4 ms-5">蛋糕類別</h3>
      <cakeSwiper></cakeSwiper>
    </div>
    <div class="pudding_container">
      <h3 class="badge fs-5 text-primary mb-4 ms-5">布丁類別</h3>
      <puddingSwiper></puddingSwiper>
    </div>
    <div class="profiterole_container">
      <h3 class="badge fs-5 text-primary mb-4 ms-5">泡芙類別</h3>
